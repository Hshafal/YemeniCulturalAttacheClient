    ...
    >
      <div className="flex flex-col justify-center items-center pt-5">
        <div className="flex justify-between md:justify-center items-center px-4 py-3 md:py-4 md:px-6">
          ...
          <div className="block md:hidden text-black px-4 w-[65%] md:w-full text-center text-md font-black">{t("navbar.logo.subtitle")}</div>
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-col items-end justify-end 	  relative">
              <button
                ...
                className="text-red-600 text-lg items-center justify-center relative p-5 hidden md:flex"
              >
