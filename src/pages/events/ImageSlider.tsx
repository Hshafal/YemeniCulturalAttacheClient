...
export default function ImageSlider({ images, title, description, date, dir }: ImageSliderProps) {
	...
	return (
		<div dir={dir} className="w-full max-w-sm mx-auto bg-white  rounded-lg overflow-hidden shadow-lg">
			<div className="p-4">
				...
				<div className="flex items-center justify-end text-gray-500 mb-2">
					<span className="text-xs">{newDate.toLocaleDateString("ru-RU")}</span>
			...
			<div className="relative aspect-[4/3] w-full overflow-hidden">
				...
				{images.map((image, index) => (
					...
					>
						<img
							src={UPLOAD_URL + "/" + image || "/placeholder.svg"}
							alt={"photo"}
