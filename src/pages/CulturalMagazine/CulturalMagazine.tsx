...
const CulturalMagazine: React.FC = () => {
  ...
  const documents = [
    ...
    { name: 'العدد الخاص للمجلة الثقافية " رِواق مبتعث " لعام 2024 - حصاد 2024', url: '/document3.pdf' },
    { name: 'العدد الخاص للمجلة الثقافية " رِواق مبتعث " لعام 2024 - حصاد 2024', url: '/book.pdf' },
  ];
